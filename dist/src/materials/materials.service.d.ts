...
export declare class MaterialsService {
    ...
    createPO(user: any, data: any): Promise<{
        id: string;
    ...
    updateGRNAccounts(id: string, user: any, data: {
    ...
    private checkAndCreateExpiryAlert;
}
