        ...
        qc_parameter_sets: [
            {
                ...
                qc_stage: 'IQC',
                parameters: [
                    { param_code: 'IQC-AMOX-001', name: 'Identity by IR', data_type: 'BOOLEAN', is_mandatory: true, display_order: 1 },
                    { param_code: 'IQC-AMOX-002', name: 'Appearance', data_type: 'TEXT', is_mandatory: true, display_order: 2 },
                    { param_code: 'IQC-AMOX-003', name: 'Water Content (%)', data_type: 'NUMERIC', unit: '%', min_value: 11.5, max_value: 14.5, is_mandatory: true, display_order: 3 },
                ],
            },
            {
                ...
                qc_stage: 'LQC',
                parameters: [
                    { param_code: 'LQC-AMOX-001', name: 'Capsule Fill Weight (mg)', data_type: 'NUMERIC', unit: 'mg', min_value: 320, max_value: 340, target_value: 330, is_mandatory: true, display_order: 1 },
                    { param_code: 'LQC-AMOX-002', name: 'Blend Moisture (%)', data_type: 'NUMERIC', unit: '%', min_value: 0, max_value: 2.0, is_mandatory: true, display_order: 2 },
                ],
            },
            {
                ...
                qc_stage: 'OQC',
                parameters: [
                    { param_code: 'OQC-AMOX-001', name: 'Dissolution at 45 min (%)', data_type: 'NUMERIC', unit: '%', min_value: 80, is_mandatory: true, display_order: 1 },
                    { param_code: 'OQC-AMOX-002', name: 'Assay by HPLC (%)', data_type: 'NUMERIC', unit: '%', min_value: 90, max_value: 110, target_value: 100, is_mandatory: true, display_order: 2 },
                ],
            },
        ],
    },
        ...
        qc_parameter_sets: [
            {
                ...
                qc_stage: 'IQC',
                parameters: [
                    { param_code: 'IQC-PARA-001', name: 'Identity by UV', data_type: 'BOOLEAN', is_mandatory: true, display_order: 1 },
                    { param_code: 'IQC-PARA-002', name: 'Melting Point (°C)', data_type: 'NUMERIC', unit: '°C', min_value: 168, max_value: 172, is_mandatory: true, display_order: 2 },
                ],
            },
            {
                ...
                qc_stage: 'LQC',
                parameters: [
                    { param_code: 'LQC-PARA-001', name: 'Granule Moisture (%)', data_type: 'NUMERIC', unit: '%', min_value: 1.5, max_value: 3.0, is_mandatory: true, display_order: 1 },
                    { param_code: 'LQC-PARA-002', name: 'Tablet Hardness (kP)', data_type: 'NUMERIC', unit: 'kP', min_value: 6.5, max_value: 9.5, target_value: 8.0, is_mandatory: true, display_order: 2 },
                    { param_code: 'LQC-PARA-003', name: 'Tablet Weight (mg)', data_type: 'NUMERIC', unit: 'mg', min_value: 490, max_value: 510, target_value: 500, is_mandatory: true, display_order: 3 },
                ],
            },
            {
                ...
                qc_stage: 'OQC',
                parameters: [
                    { param_code: 'OQC-PARA-001', name: 'Disintegration Time (min)', data_type: 'NUMERIC', unit: 'min', max_value: 15, is_mandatory: true, display_order: 1 },
                    { param_code: 'OQC-PARA-002', name: 'Assay by HPLC (%)', data_type: 'NUMERIC', unit: '%', min_value: 95, max_value: 105, target_value: 100, is_mandatory: true, display_order: 2 },
                ],
            },
        ],
    },
...
const BOMS = [
    {
        ...
        status: 'APPROVED',
        components: [
            { material_code: 'RM-AMOX-API', material_name: 'Amoxicillin Trihydrate API', component_type: 'ACTIVE', quantity_per_base_batch: 33000, unit: 'g', overage_pct: 2, is_critical: true, display_order: 1, substitutes: [] },
            { material_code: 'RM-LACTOSE', material_name: 'Lactose Monohydrate', component_type: 'EXCIPIENT', quantity_per_base_batch: 10500, unit: 'g', overage_pct: 0, is_critical: false, display_order: 2, substitutes: [] },
            { material_code: 'RM-TALC', material_name: 'Talc', component_type: 'EXCIPIENT', quantity_per_base_batch: 2000, unit: 'g', overage_pct: 0, is_critical: false, display_order: 3, substitutes: [] },
            { material_code: 'RM-MG-STEARATE', material_name: 'Magnesium Stearate', component_type: 'LUBRICANT', quantity_per_base_batch: 500, unit: 'g', overage_pct: 0, is_critical: false, display_order: 4, substitutes: [] },
            { material_code: 'RM-CAPSULE-0', material_name: 'Hard Gelatin Capsule Size 0', component_type: 'PACKAGING', quantity_per_base_batch: 102000, unit: 'units', overage_pct: 2, is_critical: true, display_order: 5, substitutes: [] },
        ],
        process_steps: [
    ...
    },
    {
        ...
        status: 'APPROVED',
        components: [
            { material_code: 'RM-PARA-API', material_name: 'Paracetamol API', component_type: 'ACTIVE', quantity_per_base_batch: 100000, unit: 'g', overage_pct: 1, is_critical: true, display_order: 1, substitutes: [] },
            { material_code: 'RM-STARCH', material_name: 'Maize Starch', component_type: 'DISINTEGRANT', quantity_per_base_batch: 10000, unit: 'g', overage_pct: 0, is_critical: false, display_order: 2, substitutes: [] },
            { material_code: 'RM-PVP-K30', material_name: 'PVP K-30 (Binder)', component_type: 'EXCIPIENT', quantity_per_base_batch: 6000, unit: 'g', overage_pct: 0, is_critical: false, display_order: 3, substitutes: [] },
            { material_code: 'RM-MG-STEARATE', material_name: 'Magnesium Stearate', component_type: 'LUBRICANT', quantity_per_base_batch: 1000, unit: 'g', overage_pct: 0, is_critical: false, display_order: 4, substitutes: [] },
            { material_code: 'RM-PURIFIED-WATER', material_name: 'Purified Water', component_type: 'EXCIPIENT', quantity_per_base_batch: 40000, unit: 'mL', overage_pct: 0, is_critical: false, display_order: 5, substitutes: [] },
        ],
        process_steps: [
...
const QC_CHECKLISTS = [
    {
        ...
        status: 'APPROVED',
        items: [
            { item_number: 1, category: 'DOCUMENTATION', instruction: 'Verify Certificate of Analysis (CoA) received from supplier matches purchase order specifications.', is_mandatory: true, requires_value: false },
            { item_number: 2, category: 'SAFETY', instruction: 'Check container integrity — no leaks, damage, or broken seals. Photograph any discrepancies.', is_mandatory: true, requires_value: false },
            { item_number: 3, category: 'EQUIPMENT', instruction: 'Record ambient temperature and humidity at time of receipt using calibrated instruments.', is_mandatory: true, requires_value: true, value_label: 'Temperature (°C)', value_type: 'NUMERIC' },
            { item_number: 4, category: 'DOCUMENTATION', instruction: 'Verify expiry date on container label against CoA. Reject if expiry is within 6 months.', is_mandatory: true, requires_value: false },
            { item_number: 5, category: 'PROCEDURE', instruction: 'Weigh representative sample as per sampling plan. Record actual weight.', is_mandatory: true, requires_value: true, value_label: 'Sample Weight (g)', value_type: 'NUMERIC' },
        ],
    },
    {
        ...
        status: 'APPROVED',
        items: [
            { item_number: 1, category: 'EQUIPMENT', instruction: 'Verify all equipment is clean and bears a valid "Cleaned" label. Record equipment ID and cleaning date.', is_mandatory: true, requires_value: false },
            { item_number: 2, category: 'PROCEDURE', instruction: 'Confirm blend uniformity sample taken at start, middle, and end of blending.', is_mandatory: true, requires_value: false },
            { item_number: 3, category: 'PROCEDURE', instruction: 'Record in-process fill weight / tablet weight check results at every 30 min interval.', is_mandatory: true, requires_value: true, value_label: 'Average Weight (mg)', value_type: 'NUMERIC' },
            { item_number: 4, category: 'DOCUMENTATION', instruction: 'All deviations from target parameters have been raised as deviation reports.', is_mandatory: true, requires_value: false },
            { item_number: 5, category: 'PREPARATION', instruction: 'Environmental monitoring (differential pressure, particle count) recorded for manufacturing area.', is_mandatory: true, requires_value: true, value_label: 'Differential Pressure (Pa)', value_type: 'NUMERIC' },
        ],
    },
];
async function main() {
    ...
    const RECEIPTS = [
        {
            ...
            expiry_date: new Date('2027-01-01'), qc_status: 'IN_STORES',
        },
        {
            ...
            expiry_date: new Date('2027-03-01'), qc_status: 'IQC_PASSED',
        },
        {
            ...
            expiry_date: new Date('2027-06-01'), qc_status: 'PENDING_IQC',
        },
        {
            ...
            expiry_date: new Date('2027-01-15'), qc_status: 'IN_STORES',
        },
        {
            ...
            expiry_date: new Date('2027-04-01'), qc_status: 'IQC_PASSED',
        },
        {
            ...
            expiry_date: new Date('2027-07-01'), qc_status: 'PENDING_IQC',
        },
        {
            ...
            expiry_date: new Date('2027-05-01'), qc_status: 'IQC_PASSED',
        },
        {
            ...
            expiry_date: new Date('2027-08-01'), qc_status: 'PENDING_IQC',
        },
        {
            ...
            expiry_date: new Date('2026-04-15'), qc_status: 'IN_STORES',
        },
        {
            ...
            expiry_date: new Date('2026-05-20'), qc_status: 'IN_STORES',
        },
    ];
    const receiptMap = {};
    ...
    const EXPIRY_ALERTS = [
        {
            ...
            days_to_expiry: 16, alert_level: 'CRITICAL',
        },
        {
            ...
            days_to_expiry: 51, alert_level: 'WARNING',
        },
    ];
    ...
    const NEW_BOMS = [
        {
            ...
            status: 'APPROVED',
            components: [
                { material_code: 'RM-AMOX-API', material_name: 'Amoxicillin Trihydrate API', component_type: 'ACTIVE', quantity_per_base_batch: 25000, unit: 'g', overage_pct: 2, is_critical: true, substitutes: [], display_order: 1 },
                { material_code: 'RM-LACTOSE', material_name: 'Lactose Monohydrate', component_type: 'EXCIPIENT', quantity_per_base_batch: 8000, unit: 'g', overage_pct: 1, is_critical: false, substitutes: [], display_order: 2 },
                { material_code: 'RM-TALC', material_name: 'Talc', component_type: 'EXCIPIENT', quantity_per_base_batch: 1500, unit: 'g', overage_pct: 1, is_critical: false, substitutes: [], display_order: 3 },
                { material_code: 'RM-MG-STEARATE', material_name: 'Magnesium Stearate', component_type: 'LUBRICANT', quantity_per_base_batch: 500, unit: 'g', overage_pct: 0, is_critical: false, substitutes: [], display_order: 4 },
                { material_code: 'RM-CAPSULE-0', material_name: 'Hard Gelatin Capsule Size 0', component_type: 'PACKAGING', quantity_per_base_batch: 102000, unit: 'units', overage_pct: 2, is_critical: true, substitutes: [], display_order: 5 },
            ],
            process_steps: [
        ...
        },
        {
            ...
            status: 'APPROVED',
            components: [
                { material_code: 'RM-PARA-API', material_name: 'Paracetamol API', component_type: 'ACTIVE', quantity_per_base_batch: 100000, unit: 'g', overage_pct: 1, is_critical: true, substitutes: [], display_order: 1 },
                { material_code: 'RM-STARCH', material_name: 'Maize Starch', component_type: 'EXCIPIENT', quantity_per_base_batch: 10000, unit: 'g', overage_pct: 1, is_critical: false, substitutes: [], display_order: 2 },
                { material_code: 'RM-PVP-K30', material_name: 'PVP K-30', component_type: 'EXCIPIENT', quantity_per_base_batch: 6000, unit: 'g', overage_pct: 1, is_critical: false, substitutes: [], display_order: 3 },
                { material_code: 'RM-MG-STEARATE', material_name: 'Magnesium Stearate', component_type: 'LUBRICANT', quantity_per_base_batch: 1000, unit: 'g', overage_pct: 0, is_critical: false, substitutes: [], display_order: 4 },
            ],
            process_steps: [
            ...
            qc_parameter_sets: [
                {
                    ...
                    qc_stage: 'IQC',
                    parameters: [
                        { param_code: 'ID_TEST', name: 'Identity Test (IR)', data_type: 'BOOLEAN', is_mandatory: true, test_method: 'BP 2023 Sec 2.2.24', display_order: 1 },
                        { param_code: 'ASSAY_PCT', name: 'Assay (%)', data_type: 'NUMERIC', unit: '%', min_value: 98.0, max_value: 102.0, target_value: 100.0, is_mandatory: true, test_method: 'BP 2023 HPLC', display_order: 2 },
                        { param_code: 'MOISTURE', name: 'Moisture Content (%)', data_type: 'NUMERIC', unit: '%', min_value: 0, max_value: 13.5, target_value: 12.0, is_mandatory: true, test_method: 'BP 2023 Sec 2.2.32', display_order: 3 },
                        { param_code: 'PARTICLE_SIZE', name: 'Particle Size (μm)', data_type: 'NUMERIC', unit: 'μm', min_value: 10, max_value: 150, is_mandatory: false, sampling_plan: '5 samples per lot', display_order: 4 },
                    ],
                },
                {
                    ...
                    qc_stage: 'LQC',
                    parameters: [
                        { param_code: 'FILL_WT', name: 'Fill Weight (mg)', data_type: 'NUMERIC', unit: 'mg', min_value: 320, max_value: 340, target_value: 330, is_mandatory: true, sampling_plan: '5 capsules per check, every 15 min', test_method: 'Analytical balance', display_order: 1 },
                        { param_code: 'BLEND_UNIFORMITY', name: 'Blend Uniformity (%RSD)', data_type: 'NUMERIC', unit: '%RSD', min_value: 0, max_value: 5.0, target_value: 2.0, is_mandatory: true, test_method: 'BP 2023 Sec 2.9.6', display_order: 2 },
                    ],
                },
                {
                    ...
                    qc_stage: 'OQC',
                    parameters: [
                        { param_code: 'WT_VARIATION', name: 'Weight Variation (mg)', data_type: 'NUMERIC', unit: 'mg', min_value: 313.5, max_value: 346.5, target_value: 330, is_mandatory: true, test_method: 'BP 2023 Sec 2.9.5', sampling_plan: '20 capsules', display_order: 1 },
                        { param_code: 'DISINTEGRATION', name: 'Disintegration Time (min)', data_type: 'NUMERIC', unit: 'min', min_value: 0, max_value: 30, target_value: 15, is_mandatory: true, test_method: 'BP 2023 Sec 2.9.1', display_order: 2 },
                        { param_code: 'DISSOLUTION', name: 'Dissolution (% released at 45 min)', data_type: 'NUMERIC', unit: '%', min_value: 80, max_value: 100, target_value: 90, is_mandatory: true, test_method: 'BP 2023 Sec 2.9.3', display_order: 3 },
                        { param_code: 'MICROBIAL', name: 'Total Microbial Count (cfu/g)', data_type: 'NUMERIC', unit: 'cfu/g', min_value: 0, max_value: 1000, is_mandatory: true, test_method: 'BP 2023 Sec 5.1.4', display_order: 4 },
                    ],
                },
            ],
        },
            ...
            qc_parameter_sets: [
                {
                    ...
                    qc_stage: 'LQC',
                    parameters: [
                        { param_code: 'TABLET_WT', name: 'Tablet Weight (mg)', data_type: 'NUMERIC', unit: 'mg', min_value: 490, max_value: 510, target_value: 500, is_mandatory: true, sampling_plan: '10 tablets per check', display_order: 1 },
                        { param_code: 'HARDNESS', name: 'Tablet Hardness (kP)', data_type: 'NUMERIC', unit: 'kP', min_value: 6.5, max_value: 9.5, target_value: 8.0, is_mandatory: true, test_method: 'Monsanto hardness tester', display_order: 2 },
                        { param_code: 'FRIABILITY', name: 'Friability (%)', data_type: 'NUMERIC', unit: '%', min_value: 0, max_value: 1.0, target_value: 0.3, is_mandatory: true, test_method: 'BP 2023 Sec 2.9.7', display_order: 3 },
                    ],
                },
                {
                    ...
                    qc_stage: 'OQC',
                    parameters: [
                        { param_code: 'ASSAY', name: 'Assay (%)', data_type: 'NUMERIC', unit: '%', min_value: 95.0, max_value: 105.0, target_value: 100.0, is_mandatory: true, test_method: 'BP 2023 HPLC', display_order: 1 },
                        { param_code: 'DISSOLUTION_PCT', name: 'Dissolution (% at 30 min)', data_type: 'NUMERIC', unit: '%', min_value: 80, max_value: 100, target_value: 90, is_mandatory: true, test_method: 'BP 2023 Paddle 50rpm', display_order: 2 },
                    ],
                },
            ],
        },
    ...
    const NEW_CHECKLISTS = [
        {
            ...
            status: 'APPROVED',
            items: [
                { item_number: 1, category: 'PREPARATION', instruction: 'Verify purchase order number matches delivery note.', is_mandatory: true, requires_value: true, value_label: 'PO Number verified', value_type: 'TEXT' },
                { item_number: 2, category: 'SAFETY', instruction: 'Don appropriate PPE (gloves, lab coat, safety glasses) before handling material.', is_mandatory: true, requires_value: false },
                { item_number: 3, category: 'EQUIPMENT', instruction: 'Verify analytical balance is calibrated and within calibration date. Record balance ID.', is_mandatory: true, requires_value: true, value_label: 'Balance ID', value_type: 'TEXT' },
                { item_number: 4, category: 'PROCEDURE', instruction: 'Check container integrity — no damage, tampering, or contamination.', is_mandatory: true, requires_value: false },
                { item_number: 5, category: 'PROCEDURE', instruction: 'Record batch/lot number from supplier label.', is_mandatory: true, requires_value: true, value_label: 'Supplier Lot Number', value_type: 'TEXT' },
                { item_number: 6, category: 'PROCEDURE', instruction: 'Verify expiry date is acceptable (minimum 18 months remaining).', is_mandatory: true, requires_value: true, value_label: 'Expiry Date on Label', value_type: 'TEXT' },
                { item_number: 7, category: 'PROCEDURE', instruction: 'Certificate of Analysis received and matches specifications.', is_mandatory: true, requires_value: false },
                { item_number: 8, category: 'DOCUMENTATION', instruction: 'All receipt details entered in system and receipt code assigned.', is_mandatory: true, requires_value: false },
                { item_number: 9, category: 'DOCUMENTATION', instruction: 'Quarantine label affixed to material pending IQC completion.', is_mandatory: true, requires_value: false },
            ],
        },
        {
            checklist_code: 'CHK-LQC-001',
            ...
            status: 'APPROVED',
            items: [
                { item_number: 1, category: 'EQUIPMENT', instruction: 'Verify capsule filling machine set-up complete and documented in BMR.', is_mandatory: true, requires_value: false },
                { item_number: 2, category: 'EQUIPMENT', instruction: 'Record balance ID used for fill weight checks.', is_mandatory: true, requires_value: true, value_label: 'Balance ID', value_type: 'TEXT' },
                { item_number: 3, category: 'SAFETY', instruction: 'Line clearance completed — no previous batch residues present.', is_mandatory: true, requires_value: false },
                { item_number: 4, category: 'PROCEDURE', instruction: 'First 10 capsules filled: check all for weight within specification.', is_mandatory: true, requires_value: true, value_label: 'Average Fill Weight (mg)', value_type: 'NUMERIC' },
                { item_number: 5, category: 'PROCEDURE', instruction: 'Capsule shell lot number matches BMR specification.', is_mandatory: true, requires_value: true, value_label: 'Capsule Lot Number', value_type: 'TEXT' },
                { item_number: 6, category: 'DOCUMENTATION', instruction: 'In-process check log updated with all readings.', is_mandatory: true, requires_value: false },
            ],
        },
    ];
    ...
    const NEW_RECEIPTS = [
        {
            ...
            expiry_date: new Date('2027-09-01'), qc_status: 'PENDING_IQC',
        },
        {
            ...
            expiry_date: new Date('2027-10-01'), qc_status: 'IQC_PASSED',
        },
        {
            ...
            expiry_date: new Date('2027-11-01'), qc_status: 'IN_STORES',
        },
        {
            ...
            expiry_date: new Date('2027-12-01'), qc_status: 'IQC_PASSED',
        },
        {
            ...
            expiry_date: new Date('2028-01-01'), qc_status: 'IN_STORES',
        },
        {
        ...
        },
        {
            ...
            expiry_date: new Date('2027-09-01'), qc_status: 'IQC_PASSED',
        },
        {
            ...
            expiry_date: new Date('2027-10-01'), qc_status: 'IN_STORES',
        },
        {
            ...
            expiry_date: new Date(Date.now() + 45 * 24 * 60 * 60 * 1000), qc_status: 'IN_STORES',
        },
        {
        ...
        },
        {
            ...
            expiry_date: new Date(Date.now() + 20 * 24 * 60 * 60 * 1000), qc_status: 'IN_STORES',
        },
    ];
    const newReceiptMap = {};
    ...
    const NEW_EXPIRY_ALERTS = [
        {
            ...
            days_to_expiry: 45, alert_level: 'WARNING',
        },
        {
            material_code: 'RM-PARA-API', material_name: 'Paracetamol API',
        ...
        },
        {
            ...
            days_to_expiry: 20, alert_level: 'CRITICAL',
        },
    ];
