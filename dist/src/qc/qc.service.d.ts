...
export declare class QcService {
    ...
    submitResults(testId: string, user: any, results: Array<{
        parameter_id: string;
        parameter_name: string;
        unit?: string;
        min_value?: number;
    ...
    recordVerdict(testId: string, user: any, verdict: string, notes?: string): Promise<{
        id: string;
        status: import(".prisma/client").$Enums.QCTestStatus;
        step_number: number | null;
        completed_by: string | null;
    ...
    createChecklist(user: any, data: any): Promise<{
        id: string;
        status: import(".prisma/client").$Enums.SOPStatus;
        created_by: string;
        created_at: Date;
    ...
    addChecklistItems(checklistId: string, user: any, items: any[]): Promise<{
        items: {
            id: string;
            is_mandatory: boolean;
            item_number: number;
    ...
    startChecklistExecution(user: any, checklistId: string, qcTestId: string): Promise<{
        id: string;
        status: import(".prisma/client").$Enums.ChecklistExecStatus;
        completed_at: Date | null;
        qc_test_id: string;
    ...
    updateChecklistItem(executionId: string, itemId: string, user: any, data: {
        is_completed: boolean;
    ...
    completeChecklistExecution(executionId: string, user: any): Promise<{
        id: string;
        status: import(".prisma/client").$Enums.ChecklistExecStatus;
        completed_at: Date | null;
        qc_test_id: string;
