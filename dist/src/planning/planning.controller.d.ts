...
export declare class PlanningController {
    ...
    addPlannedBatch(id: string, req: any, body: any): Promise<{
        planned_batch: {
            id: string;
            status: import(".prisma/client").$Enums.PlannedBatchStatus;
            bom_id: string;
    ...
    simulatePlan(id: string): Promise<any[]>;
    approvePlan(id: string, req: any, body: {
        signature?: any;
    }): Promise<{
        id: string;
        status: import(".prisma/client").$Enums.PlanStatus;
    ...
    initiateBatch(planId: string, batchId: string, req: any, body: {
        templateId: string;
        batchNumber: string;
    }): Promise<{
        id: string;
