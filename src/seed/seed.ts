...
async function main() {
  ...
  const QC_SPECS = [
    {
      ...
      status: 'APPROVED' as const,
      parameters: [
        { param_code: 'IQC-AMOX-ID', name: 'Identity (IR Spectroscopy)', qc_stage: 'IQC' as const, data_type: 'BOOLEAN' as const, is_mandatory: true, test_method: 'BP 2023, IR method', display_order: 1 },
        { param_code: 'IQC-AMOX-WC', name: 'Water Content (%)', qc_stage: 'IQC' as const, data_type: 'NUMERIC' as const, unit: '%', min_value: 11.5, max_value: 14.5, is_mandatory: true, test_method: 'Karl Fischer', display_order: 2 },
        { param_code: 'LQC-FILL-WT', name: 'Capsule Fill Weight (mg)', qc_stage: 'LQC' as const, data_type: 'NUMERIC' as const, unit: 'mg', min_value: 320, max_value: 340, target_value: 330, is_mandatory: true, test_method: 'Analytical balance', sampling_plan: '5 capsules q30min', display_order: 3 },
        { param_code: 'OQC-DISS', name: 'Dissolution at 45 min (%)', qc_stage: 'OQC' as const, data_type: 'NUMERIC' as const, unit: '%', min_value: 80, max_value: 100, target_value: 90, is_mandatory: true, test_method: 'BP 2023 Sec 2.9.3', sampling_plan: '6 capsules', display_order: 4 },
        { param_code: 'OQC-ASSAY', name: 'Assay by HPLC (%)', qc_stage: 'OQC' as const, data_type: 'NUMERIC' as const, unit: '%', min_value: 95.0, max_value: 105.0, target_value: 100.0, is_mandatory: true, test_method: 'BP 2023 HPLC method', display_order: 5 },
      ],
    },
    {
      ...
      status: 'APPROVED' as const,
      parameters: [
        { param_code: 'IQC-PARA-ID', name: 'Identity (UV Spectroscopy)', qc_stage: 'IQC' as const, data_type: 'BOOLEAN' as const, is_mandatory: true, test_method: 'BP 2023 UV method', display_order: 1 },
        { param_code: 'LQC-TABLET-WT', name: 'Tablet Weight (mg)', qc_stage: 'LQC' as const, data_type: 'NUMERIC' as const, unit: 'mg', min_value: 490, max_value: 510, target_value: 500, is_mandatory: true, test_method: 'Analytical balance', sampling_plan: '10 tablets per check', display_order: 2 },
        { param_code: 'LQC-HARDNESS', name: 'Tablet Hardness (kP)', qc_stage: 'LQC' as const, data_type: 'NUMERIC' as const, unit: 'kP', min_value: 6.5, max_value: 9.5, target_value: 8.0, is_mandatory: true, test_method: 'Monsanto hardness tester', display_order: 3 },
        { param_code: 'OQC-DISS-PARA', name: 'Dissolution at 30 min (%)', qc_stage: 'OQC' as const, data_type: 'NUMERIC' as const, unit: '%', min_value: 80, max_value: 100, target_value: 90, is_mandatory: true, test_method: 'BP 2023 Paddle 50rpm', display_order: 4 },
        { param_code: 'OQC-ASSAY-PARA', name: 'Assay (%)', qc_stage: 'OQC' as const, data_type: 'NUMERIC' as const, unit: '%', min_value: 95.0, max_value: 105.0, is_mandatory: true, test_method: 'BP 2023 HPLC', display_order: 5 },
      ],
    },
  ];
  ...
  // ─── Phase 3: Environmental Monitoring Areas ───────────────────────────────
  ...
  // Seed some environmental readings
  ...
  const ENV_READINGS = [
    { area_code: 'MA-001', reading_type: 'TEMPERATURE', value: 24.2, unit: '°C', status: 'PASS' as const },
    { area_code: 'MA-001', reading_type: 'HUMIDITY', value: 52.1, unit: '%RH', status: 'PASS' as const },
    { area_code: 'MA-001', reading_type: 'PRESSURE_DIFFERENTIAL', value: 13.5, unit: 'Pa', status: 'PASS' as const },
    { area_code: 'MA-002', reading_type: 'TEMPERATURE', value: 26.8, unit: '°C', status: 'BORDERLINE' as const },
    { area_code: 'MA-002', reading_type: 'HUMIDITY', value: 58.3, unit: '%RH', status: 'BORDERLINE' as const },
    { area_code: 'MA-003', reading_type: 'TEMPERATURE', value: 21.5, unit: '°C', status: 'PASS' as const },
    { area_code: 'MA-003', reading_type: 'HUMIDITY', value: 48.9, unit: '%RH', status: 'PASS' as const },
  ];
  ...
  // ─── Phase 3: Stock Entries (seed ledger for existing in-store receipts) ────
